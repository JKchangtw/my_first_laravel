                ...
                <tbody>
                    ...
                    @foreach ($orders as $item)
                        <tr>
                            ...
                            <td class="goods_name">{{ $item->total }}</td>
                            <td class="goods_price">{{ $item->name }}</td>
                            <td class="goods_count">{{ $item->status }}</td>
                            <td class="goods_intro">{{ $item->ps }}</td>
                            <td>
                                {{-- <a href="/good/edit/{{ $good->id }}">編輯</a> --}}
                                {{-- button onclick寫法 --}}
                                <button class="btn edit"
                                    onclick="location.href='/order/edit/{{ $item->id }}'">編輯</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
